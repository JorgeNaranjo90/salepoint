<div class="container">
   ...
   <div class="row">
       <div class="form-group col-lg-4">
                   {!! Form::label('partner_id', 'Cliente', ['class' => 'control-label']) !!}
       ...
       <div class="form-group col-lg-2">
           {!! Form::label('paymentMethod_id', trans('paymentMethods.typeMethods')) !!}
           {!! Form::select('paymentMethod_id',$paymentMethod, null, ['class' => 'form-control  requiered_field']) !!}
       </div>
       <div class="form-group col-lg-2">
           {!! Form::label('type', 'Tipo de Documento') !!}
           {!! Form::select('type', ['saleOrder' =>'Nota de venta', 'invoice' => 'Factura' ], null, ['class' => 'form-control  requiered_field']) !!}
       </div>
   </div>
    <div class="row">
        <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
            <li class="active"><a href="#order_lines" data-toggle="tab">Detalles de la venta</a></li>
