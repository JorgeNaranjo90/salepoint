...
Route::group(['namespace'=>'Partners', 'middleware' => ['auth','is_admin','is_user','is_sale','is_purchase']], function() {
    ...
    Route::get('partners/customer',['as' => 'partners.customer','middleware' => ['is_admin','is_user','is_sale','is_purchase'] ,'uses' => 'PartnersController@customer']);
    Route::get('partners/supplier', ['as' => 'partners.supplier','middleware' => ['is_admin','is_user','is_sale','is_purchase'] , 'uses' => 'PartnersController@supplier']);
    Route::get('partners/delete', ['as' => 'partners.onlyTrashed', 'middleware' => ['is_admin'] ,'uses' => 'PartnersController@delete']);
    Route::get('partners/report', ['as' => 'partners.reports', 'middleware' => ['is_admin','is_user','is_report'] ,'uses' => 'PartnersController@report']);
    Route::get('partners/reportCustomer', ['as' => 'partners.reports', 'middleware' => ['is_admin','is_user','is_purchase','is_report'] ,'uses' => 'PartnersController@reportCustomer']);
    Route::get('partners/reportSupplier', ['as' => 'partners.reports','middleware' => ['is_admin','is_user','is_purchase','is_report'] , 'uses' => 'PartnersController@reportSupplier']);
...
Route::get('sales', ['as' => 'sales', 'middleware' => ['auth','is_admin','is_user','sales'], 'uses' => 'GeneralController@sales']);
Route::get('purchases', ['as' => 'purchases', 'middleware' => ['auth','is_user','is_purchase'], 'uses' => 'GeneralController@purchases']);
